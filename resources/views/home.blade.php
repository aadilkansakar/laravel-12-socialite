                        ...
                        <div class="card rounded-0 border-0 card2" id="paypage">
                            <div class="form-card">
                                ...
                                <div class="radio-group">
                                    <div class='radio' data-value="credit"><a href="{{ route('esewa.pay') }}"><img src="https://upload.wikimedia.org/wikipedia/commons/f/ff/Esewa_logo.webp"
                                            width="200px" height="60px"></a></div>
                                    <div class='radio' data-value="paypal"><a href="{{ route('khalti.pay') }}"><img src="https://khaltibyime.khalti.com/wp-content/uploads/2025/07/Logo-for-Blog.png"
                                            width="200px" height="60px"></a></div>
                                    <br>
                                </div>
